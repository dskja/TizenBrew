...
First, fork the [TizenBrew repository](https://github.com/dskja/TizenBrew) on GitHub.
...
Add your language to the `resources` object in [here](https://github.com/dskja/TizenBrew/blob/main/tizenbrew-app/TizenBrew/tizenbrew-ui/src/components/i18nResources.js#L20) following the same format as the other languages (`English Name (Native Name)`).
